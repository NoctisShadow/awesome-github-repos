...
*   [WEP-56/JAVBUS](https://github.com/WEP-56/JAVBUS) - 一个插件式BT种子搜索器，通过为BHT爬虫网站、BT资源收集网站制作html正则匹配json插件，来实现一个软件-全网资源的效果。同时支持网盘搜索、局域网互传
...
*   [yeahhe365/LongImg-Splitter](https://github.com/yeahhe365/LongImg-Splitter) - 将长截图/长图智能分割为多页 PDF 文件 | Split long screenshots/images into multi-page PDF files
...
*   [asionesjia/jetbrains](https://github.com/asionesjia/jetbrains) -
...
*   [webLiang/Pornhub-Video-Downloader-Plugin-v3](https://github.com/webLiang/Pornhub-Video-Downloader-Plugin-v3) - pornhub视频下载插件 chrome extention v3,pornhub video download, support xvideos, xhamaster and more.
...
*   [DemoJ/CopyGo](https://github.com/DemoJ/CopyGo) - 像开发者工具一样选择网页元素，提取文字复制或导出为 TXT 或 Markdown。

*   [lueluelue2006/chatgpt-perf-mv3](https://github.com/lueluelue2006/chatgpt-perf-mv3) -
...
*   [no1xuan/photo](https://github.com/no1xuan/photo) - 证件照小程序——前端（第一套）
...
*   [17fun/17fei](https://github.com/17fun/17fei) - 情侣飞行棋 - 姿势卡 游戏
...
*   [malaaaaaa/pikpak\_scripts](https://github.com/malaaaaaa/pikpak_scripts) -
...
*   [IACJ/react-datastructer](https://github.com/IACJ/react-datastructer) - 数据结构在线模拟器
...
*   [dundunnp/auto\_xuexiqiangguo](https://github.com/dundunnp/auto_xuexiqiangguo) - 学习强国 每日拿满61分！免root 四人赛双人对战秒答 自动化脚本
...
*   [SYJun404/LPLDataShow](https://github.com/SYJun404/LPLDataShow) -
...
*   [qichunren/double\_sync](https://github.com/qichunren/double_sync) - Auto sync operation between chrome windows
...
*   [huihuihenqiang/Cluely-interview](https://github.com/huihuihenqiang/Cluely-interview) - 面试辅助，学习面试技巧利用gpt、语音识别、OCR、RAG

*   [jwangkun/hermes-agent-guide](https://github.com/jwangkun/hermes-agent-guide) - Hermes Agent 是目前开源社区最具潜力的 AI Agent 框架之一。它继承了 OpenClaw 的优秀基因，在架构设计、记忆系统、技能生态和自动化能力上实现全面升级。但 Hermes 的文档分散在多个仓库和平台，缺乏一本系统性的中文指南。  本书填补的正是这个空白。全书 16 册、30 万+ 字，覆盖从安装部署到高阶开发、从个人玩赚到企业服务、从单 Agent 操控到多 Agent 编排的完整知识图谱。
...
*   [EchterAlsFake/Porn\_Fetch](https://github.com/EchterAlsFake/Porn_Fetch) - Cross-Platform Porn (Hub) downloader with Account Login and Searching support

*   [james-6-23/oai-team-auto-provisioner](https://github.com/james-6-23/oai-team-auto-provisioner) -
...
*   [sfz009900/fuckfanyipublic](https://github.com/sfz009900/fuckfanyipublic) - OCR截图AI翻译,AI学习英语,OCR screenshot AI translation, AI learning English
...
*   [WizardLoop/GetAnyMessage](https://github.com/WizardLoop/GetAnyMessage) - A Telegram Bot to receive restricted message content from any chat!

*   [hmjz100/Stellar](https://github.com/hmjz100/Stellar) - GitHub Stellar - 星标数据分析工具

*   [qq254950134/my\_tvbox](https://github.com/qq254950134/my_tvbox) - 用于整合影视仓/tvbox本地包，提高访问速度
...
*   [mike126126/bing](https://github.com/mike126126/bing) - Bing首页每日更新一张来自世界各地的精美图片。通过imgRun提供的API链接可以简单、快速地获取栩栩如生的每日壁纸，每日自动更新，作为网站背景和电脑壁纸都非常不错…… https://bing.img.run/
...
*   [zpj80231/idea-set](https://github.com/zpj80231/idea-set) - ✅ JetBrains And IntelliJ IDEA 自用配置、常用插件、打包整理。
...
*   [liuzi6612/linux-manual](https://github.com/liuzi6612/linux-manual) - 🐧 Linux command reference manual; Linux 常用命令参考手册, 日常运维的最佳拍档。
...
*   [appsail/Gemini-in-Chrome](https://github.com/appsail/Gemini-in-Chrome) -
...
*   [vigorX777/ppt-svg-generator](https://github.com/vigorX777/ppt-svg-generator) - ppt-svg-generator 是一个 Skill，帮助你将 Markdown 文稿快速转化PPT 或 PDF，并支持多种预设风格选择，效果美观且可控。 使用流程参考公众号：懂点儿 AI 👇
...
*   [exception-coder/npe\_get\_jobs](https://github.com/exception-coder/npe_get_jobs) - “让求职像刷剧一样简单。” 本工具可自动连接各大招聘网站，AI 帮你筛选职位、写打招呼语、自动投递简历——实现真正的全自动化智能求职。
...
*   [Super1Windcloud/hyperscoop](https://github.com/Super1Windcloud/hyperscoop) - 🦀🐦‍🔥 Next-generation, faster, more powerful, and more refined Windows package manager
...
*   [Zheng-up/zAugment](https://github.com/Zheng-up/zAugment) - zaugment
...
*   [synercys/annotated\_latex\_equations](https://github.com/synercys/annotated_latex_equations) - Examples of how to create colorful, annotated equations in Latex using Tikz.
...
*   [JUSTSUJAY/nlp-zero-to-hero](https://github.com/JUSTSUJAY/nlp-zero-to-hero) - NLP Zero to Hero in just 10 Kernels
...
*   [metafy-social/python-scripts](https://github.com/metafy-social/python-scripts) - A repository of python scripts that come in handy in automating day-to-day tasks
...
*   [blindpirate/does-alibaba-follow-their-own-guidelines](https://github.com/blindpirate/does-alibaba-follow-their-own-guidelines) -

## Handlebars

*   [geneasy/nav](https://github.com/geneasy/nav) - 网址导航模板 - 这是一个通用的网址导航模板，任何类型的网站都可以拿去使用。此网址导航页面是使用 GenEasy 文档生成工具 + WebStack 模板创建的静态页面，托管在 GitHub Pages 服务器上面。例子: https://zh.pipecraft.net/
